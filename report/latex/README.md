...
Figure 1 is a proposed institutional diagram. Figure 2 uses recorded authorized-completion outcomes. Neither depicts a demonstrated welfare effect, a trained human service or a safety advantage from representation. First-contact analysis is explicitly post hoc; proposed follow-ups have not run.
