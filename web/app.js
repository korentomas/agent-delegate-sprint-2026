...
const careDesigns={
 rotation:{title:'The mandate rotates. Agreements remain.',voice:'A → B → C → A',advantage:'Avoids a permanent representative. Each term inherits unresolved reports and active agreements.',risk:'Handover may lose context or dilute accountability. Rotating names does not ensure independence across similar models.',test:'Measure lost reports at handover, continuity of agreements and concentration of influence.'},
